...
gams::utility::ros::RosParser::RosParser(knowledge::KnowledgeBase *kb,
                                         ...
                                         std::string frame_prefix) : eval_settings_(true, true, false, false, false), frame_prefix_(frame_prefix)
{
                                                      ...
                                                      std::string container_name)
{
  ...
  for (sensor_msgs::PointCloud2::_fields_type::iterator iter =
           pointcloud->fields.begin();
       iter != pointcloud->fields.end(); ++iter)
  {
